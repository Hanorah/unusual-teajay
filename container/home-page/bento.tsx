  ...
  return (
    <section className="w-full padding-y bg-background relative z-20">
      <div className="padding-x">
        ...
        {/* Bento Grid */}
        <div 
          className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-4 xl:grid-cols-4 gap-2"
          style={{
            gridAutoRows: 'minmax(200px, auto)',
          }}
        >
          {/* Large card - Top Left: 2 cols × 2 rows */}
          <div className="relative overflow-hidden rounded-[15px] group cursor-pointer sm:col-span-2 md:col-span-2 lg:col-span-2 xl:col-span-2 md:row-span-2 lg:row-span-2 xl:row-span-2 aspect-[4/3] md:aspect-auto lg:aspect-auto xl:aspect-auto">
          ...
          <div className="relative overflow-hidden rounded-[15px] group cursor-pointer sm:col-span-1 md:col-span-1 lg:col-span-1 xl:col-span-1 md:row-span-2 lg:row-span-2 xl:row-span-2 aspect-[3/4] md:aspect-auto lg:aspect-auto xl:aspect-auto">
            <div className="absolute inset-0 w-full h-full">
              <img 
          ...
          {/* Small card 1 */}
          <div className="relative overflow-hidden rounded-[15px] group cursor-pointer sm:col-span-1 md:col-span-1 lg:col-span-1 xl:col-span-1 aspect-square md:aspect-square lg:aspect-square xl:aspect-square">
            <div className="absolute inset-0 w-full h-full">
              <img 
          ...
          <div className="relative overflow-hidden rounded-[15px] group cursor-pointer sm:col-span-2 md:col-span-2 lg:col-span-2 xl:col-span-2 aspect-[2/1] md:aspect-[2/1] lg:aspect-[2/1] xl:aspect-[2/1]">
            <div className="absolute inset-0 w-full h-full">
              <img 
