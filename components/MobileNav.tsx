...
export default function MobileNav() {
	...
	return (
		<>
			<div className="w-full hidden justify-between items-center h-[10vh] padding-x sm:flex xm:flex md:flex fixed top-0 left-0 z-50 backdrop-blur-[20px] bg-white/80 border-b border-black/5">
				<Link href={"/"}>
					<Image
						src={logo}
						alt="ochi logo"
